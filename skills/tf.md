---
name: tf
description: "Terraform review, scaffolding, and version upgrades for AWS infrastructure. Use when user says 'review my terraform', 'before I raise an MR', 'scaffold a lambda/rds/s3/eks/vpc', 'check my .tf files', 'upgrade provider', or when working in .tf or .tfvars files."
metadata:
  version: 1.1.0
  author: Anmol Nagpal
  category: devops
